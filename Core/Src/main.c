...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, WIFI_RST_Pin|WIFI_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : WIFI_WAKEUP_Pin */
  ...
  /*Configure GPIO pin : WIFI_DATARDY_Pin */
  GPIO_InitStruct.Pin = WIFI_DATARDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(WIFI_DATARDY_GPIO_Port, &GPIO_InitStruct);
...
{
    // On envoie le texte caractère par caractère sur l'UART 1
