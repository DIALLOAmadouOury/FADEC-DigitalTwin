...
#define AI_TOOLS_DATE_TIME   "2026-05-05T01:34:53+0200"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 292, 1, 1),
    292, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    nl_1_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 16);
    nl_1_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 256);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 256);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 272);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 272);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 288);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 288);
    return true;
  }
